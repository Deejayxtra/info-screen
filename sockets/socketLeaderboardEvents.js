...
import { getJustEndedRace } from "../utils/getJustEndedRace.js";
...
export const setupLeaderboardEvents =  (io, socket) => {
    const leaderboardEvents = async () => {
    ...
    socket.on("getLeaderboardData", leaderboardEvents);
}
